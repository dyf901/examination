...
public class TrainCommonality {
    ...
    @ApiModelProperty(value = "标题图片" , name = "img")
    private String img;
    ...
    public TrainCommonality(int id, int type_id, int genre_id, String commonality_name, String type_name, String genre_name, String img, String content, String video_url) {
        this.id = id;
